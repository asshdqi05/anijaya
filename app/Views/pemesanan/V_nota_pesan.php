...
<head>
    <meta charset="UTF-8">
    <title>Nota Pemesanan Barang</title>
</head>
                    ...
                    <table style="border-collapse: collapse; width: 90%;" border="0">
                        <tr>
                            ...
                            <td style="text-align: center; width: 40px;">
                                ...
                                <span style="font-size: 18pt; font-weight: bold; color: black;">Nota Pemesanan Barang</span><br>
                ...
                <td align="">
                    <table>
                        <tr>
                            <td>Tanggal</td>
                            <td>:</td>
                            <td><?= date('d F Y', strtotime($pemesanan->tanggal)) ?></td>
                        </tr>
                        <tr>
                            <td>No Faktur</td>
                            <td>:</td>
