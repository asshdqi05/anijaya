...
<div class="card">
    <div class="card-header bg-dark">
        <a class="btn btn-primary btn-flat" href="<?= site_url('C_pemesanan') ?>">
            <span><i class="fas fa-chevron-circle-left"></i></span>
            Kembali
        </a>
    </div>
    <form action="<?= site_url('C_pemesanan/save') ?>" method="POST">
        <div class="card-body">
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" readonly class="form-control" id="nama_pelanggan" name="pelanggan" required>
                            <span class="input-group-append">
                                <button type="button" data-toggle="modal" data-target="#cari_pelanggan" class="btn btn-info">Cari <i class="fas fa-search"></i></button>
                            </span>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function cetakfaktur() {
        ...
        newwindow = window.open('<?php echo site_url('C_pemesanan/cetak_nota/') ?>' + faktur, 'name', 'height=600,width=600,scrollbars=yes');
        if (window.focus) {
            newwindow.focus();
        }
        return false;
...
<div class="modal fade" id="cari_pelanggan">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                    ...
                    <tbody>
                        ...
                        foreach ($pelanggan as $d) :
                            ...
                            <tr>
                                ...
                                <td><?= $d->alamat ?></td>
                                <td>
                                    <button type="button" class="btn btn-primary" onclick="return pilih_pelanggan('<?= $d->id ?>','<?= $d->nama_pelanggan ?>')">
                                        Pilih
                                    </button>
                                </td>
                            </tr>
